  ...
  return (
    <SceneShell id={id}>
      ...
      >
        ...
        <div
          style={{...font, opacity: e2.opacity, color: C.muted, fontSize: 34, fontWeight: 600}}
        >
...
export const NewsCard: React.FC<{item: NewsItem}> = ({item}) => {
  ...
  const highlight = useEntrance(id, 0.75, 0.7);
  ...
  return (
    <SceneShell id={id}>
      ...
      >
        <div style={{...font, display: 'flex', alignItems: 'center', gap: 14}}>
          <div
            style={{
          ...
          >
            ...
            <div>
              ...
              <div style={{...font, color: C.muted, fontSize: 24, fontWeight: 600}}>{item.category}</div>
            </div>
          </div>
        </div>
        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: 26}}>
          ...
          >
            <div
              style={{...font, color: C.accent2, fontSize: 24, fontWeight: 700, marginBottom: 12, letterSpacing: 2}}
            >
              本期看点
            </div>
            <div style={{...font, color: C.text, fontSize: 38, fontWeight: 700, lineHeight: 1.3}}>
              {item.screenText}
            </div>
          </div>
          <ProgressBar id={id} />
